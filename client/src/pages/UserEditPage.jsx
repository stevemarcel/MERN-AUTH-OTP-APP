...
const UserEditPage = () => {
	...
	const { data: userData, isLoading: isGettingUser } =
				...
				<div>
					<div className="flex items-center mb-4">
						...
						>
							...
							{mode === "view" ? "" : "Edit"} {userData.firstName}{" "}
							{userData.lastName} {mode === "view" ? "User" : ""}
						</div>
					</div>
								...
								>
									...
									<div className="flex gap-3 text-xs md:text-sm mt-4 md:mt-14">
										<button
											...
											className={`flex items-center justify-center px-3 py-2  text-white rounded transition duration-300 hover:scale-105 hover:shadow-md ${
												mode === "edit"
										...
										{mode === "edit" && (
											<button
												type="button"
												className="flex items-center justify-center px-4 py-2 bg-red-800 hover:bg-red-800/90 w-1/2 text-white rounded transition duration-300 hover:scale-105 hover:shadow-md"
												onClick={cancelEdits}
											>
												<div className="mr-2">
													<FaTimes />
